module github.com/dacineu/PsiphonNGLinux
...
// For development, replace with local psiphon-tunnel-core
replace github.com/Psiphon-Labs/psiphon-tunnel-core => ../psiphon-tunnel-core

// The following replaces are from psiphon-tunnel-core and are needed
// to use the custom forks of pion libraries with Psiphon modifications.
// These are required for in-proxy (WebRTC) functionality.

replace (
	github.com/pion/dtls/v2 => ../psiphon-tunnel-core/replace/dtls
	github.com/pion/ice/v2 => ../psiphon-tunnel-core/replace/ice
	github.com/pion/webrtc/v3 => ../psiphon-tunnel-core/replace/webrtc
